      ...
      <div className="sec w-full sm:w-[80%] bg-[#f6f7f9] p-4 sm:p-6  flex flex-col gap-10 font-[family-name:var(--font-geist-sans)]">
        ...
        <section className="popular w-full flex flex-col gap-4">
          <div className="sec grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { title: 'Koenigsegg', image: '/car1.png', desc: 'Sport' },
              { title: 'Nissan GT - R', image: '/car2.png', desc: 'Luxury' },
              { title: 'Rolls-Royce', image: '/car3.png', desc: 'Sport' },
            ...
            //   { title: 'NEW MGZS', image: '/cd.png', desc: 'SUV' },
            ].map((car, index) => (
